  ...
  <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <form method="post" class="was-validated">
      <div class="mb-3 ms-2">
        ...
        <input class="form-control" type="text" name="edit_username" placeholder="Username" required />
        <div class="invalid-feedback">
          Please choose a username.
        </div><br />
        <input class="form-control" type="text" name="edit_email" placeholder="Email Address" required />
        <div class="invalid-feedback">
